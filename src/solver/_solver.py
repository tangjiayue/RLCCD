...
class BaseSolver(object):
    ...
    def load_state_dict(self, state):
        ...
        for k, v in self.__dict__.items():
            # #跳过恢复 scheduler 我改了lr的话
            # if k == "lr_scheduler":
            #     print("Skip loading lr_scheduler.state_dict (manual override enabled)")
            #     continue
            # if k == "lr_warmup_scheduler":
            #     print("Skip loading lr_warmup_scheduler.state_dict")
            #     continue
